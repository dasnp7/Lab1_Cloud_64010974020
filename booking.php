    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-sm-11 col-md-7 devbanban" style="margin-top: 50px;">
          <br>
          <h4 align="center" style="color: black;">จองโต๊ะ</h4>
          <br>
          <div class="row">
            <div class="col-sm-12 col-md-12">
              <div class="alert alert-warning" role="alert">
                <center><font color="black"> <b>จองโต๊ะ และเวลา</b></font> </center>
              </div>
              <hr>
                  ...
                  <form action="save_booking.php" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                       ...
                       <button type="submit" class="btn btn-info">บันทึกการจอง</button>
                       <a href="index.php" target="_blank">
                       <button type="button" class="btn btn-info">กลับไปหน้าเลือกโต๊ะ</button></a>
